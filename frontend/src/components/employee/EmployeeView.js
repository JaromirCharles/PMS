...
export default function EmployeeView(cView) {
    ...
    function createEmployeeData() {
      const rows = [
        createData('Rammstein', 'Construction and Dismantling ...', 'Stuttgart', '08:00 - 20:00', 'apply'),
        createData('Ninja Warrior', 'Cleaning up the splashed water.', 'Zurich', '09:00 - 21:00', 'apply'),
        createData('...', '...', '...', '...', '...'),
        createData('...', '...', '...', '...', '...'),
        createData('...', '...', '...', '...', '...'),
      ];
        ...
        <TableBody>
          {tableData.map((row) => (
            ...
            >
              ...
              <StyledTableCell className={classes.applyHover}>{row.empty}</StyledTableCell> 
